    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12"> <br>
                <img style="margin-bottom :20px;" src="./image/logo.png" alt="ร้านไอศครีมไผ่ทอง" /><br />
                <h3>ข้อมูลออเดอร์<a href="addorder.php" class="btn btn-info float-end">+เพิ่มออเดอร์</a> </h3> <br />
                ...
                <table id="flavorTable" class="display table table-striped  table-hover table-responsive table-bordered ">
                    ...
                    <tbody>
                        ...
                        require 'connect.php';
                        $sql =
                            'SELECT * FROM orderdetail,flavor WHERE orderdetail.FlavorID=flavor.FlavorID';
